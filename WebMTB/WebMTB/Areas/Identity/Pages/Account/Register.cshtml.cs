        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var otpResult = _otpService.GenerateOtp(Input.Email, "confirm-email");
    ...
    <div style='font-family:Arial,sans-serif;background:#111;padding:32px;color:#fff;'>
        <div style='max-width:560px;margin:0 auto;background:#1b1b1f;border-radius:18px;padding:28px;border:1px solid #333;'>
            ...
            <p style='color:#ccc;line-height:1.6;'>
                Mã OTP xác thực tài khoản CineZone của bạn là:
            </p>
            ...
            <p style='color:#aaa;font-size:14px;'>
                Mã OTP có hiệu lực trong 5 phút. Không chia sẻ mã này cho người khác.
                    ...
                    return RedirectToPage("./ConfirmEmailOtp", new { email = Input.Email });
                }
            }
