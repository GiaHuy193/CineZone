    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (loginUser != null && !await _userManager.IsEmailConfirmedAsync(loginUser))
                {
                    ModelState.AddModelError(string.Empty, "Vui lòng xác thực tài khoản qua email trước khi đăng nhập.");
                    return Page();
                }
